...
if (isset($_POST['name']) && isset($_POST['class']) && isset($_POST['teacher']) && isset($_POST['id'])  && isset($_POST['phone'])) {
  ...
  if (!$db->update("t_student", $data,$data['id'])) {
    echo "插入数据失败";
  }
  ...
  if (isset($_POST['project'])) {
    ...
    if (!$db->update("t_stu_pro", $data,$data['studentid'])) {
      echo "插入数据失败";
    }
  }
  ...
  if (!isset($_POST['laboratory'])) {
    ...
    if ($db->update("t_stu_laboratory", $data,$data['studentid'])) {
      echo "插入数据失败";
    }
  }
    ...
    <div class="contentpanel">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">修改学生信息</h4>
        </div>
        <div class="panel-body panel-body-nopadding">
          ...
          <form id="form" class="form-horizontal form-bordered" method="post" action="changStudent.php">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="学号" class="form-control" name="id" value = "<?php echo $it['id'] ?>" readonly = true/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="班级" class="form-control" name="class" value = "<?php echo $it['class'] ?>"/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="手机号" class="form-control" name="phone" value = "<?php echo $it['phone'] ?>"/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input list="bj1" placeholder="教师" class="form-control" name="teacher" value = "<?php echo $it['teacherid'] ?>"/>
                <datalist id="bj1">
                    <?php 
                    if (is_root) {
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input list="bj2" placeholder="实验室" class="form-control" name="laboratory" value = "<?php echo $it['laboratoryid'] ?>"/>
                <datalist id="bj2">
                    <?php 
                    if (is_root) {
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input list="bj3" class="form-control" placeholder="项目" name="project" value = "<?php echo $it['proid'] ?>" />
                <datalist id="bj3">
                    <?php 
                    if (is_root) {
